...
Create a logical vector that contains TRUE values that contains keyword ID, mean and stdev columns and FALSE values for the others.
...
Use regular expressiontechnique and gsub grepl for pattern replacement to clean up the data labels.
